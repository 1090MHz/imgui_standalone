...
from imgui import (create_context as imgui_create_ctx, get_io as imgui_io, new_frame, begin, end, set_window_size, set_window_position, render as imgui_render, get_draw_data)
...
# Import the ImGuiStandaloneUtilities class
from .imgui_utilities import ImGuiStandaloneUtilities
...
class ImGuiStandalone:
    ...
    def __init__(self, title: str, width: int, height: int, always_on_top: bool=False, show_hide_key: int=DEFAULT_SHOW_HIDE_KEY, background_color: tuple[int, int, int]=(0, 0, 0), imgui_flags: Any=None) -> None:
        ...
        set_caption(title)
        window = getActiveWindow(); (window.move(-width // 2, -height // 2), window.alwaysOnTop(always_on_top)); del window
